...
abstract class $LoginStatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({String mail, String password, bool isError});
}
...
class _$LoginStatusImpl implements _LoginStatus {
  _$LoginStatusImpl({this.mail = '', this.password = '', this.isError = false});
  ...
  @override
  String toString() {
    return 'LoginStatus(mail: $mail, password: $password, isError: $isError)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, mail, password, isError);
...
abstract class _LoginStatus implements LoginStatus {
  factory _LoginStatus(
      {final String mail,
      final String password,
      final bool isError}) = _$LoginStatusImpl;
